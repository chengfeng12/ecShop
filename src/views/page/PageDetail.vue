<template>
  <div class="container">
    ...
    <div class="page-content">
      <!-- 页面导航区域 -->
      <div class="page-nav">
        <Button type="primary" class="comMg" @click="handleShowClick">+添加新页面</Button>
        <Select v-model="model1" style="width:200px" class="comMg">
          <Option v-for="item in list" :value="item.value" :key="item.value">{{ item.label }}</Option>
        </Select>
        <Input placeholder="输入页面关键词搜索" style="width: 300px;" class="comMg"></Input>
        <Button type="primary" class="comMg">搜索</Button>
      </div>
      <!-- 选项卡区域 -->
      <div class="page-tab">
        <!-- 选项卡 -->
        <Tabs type="card">
          ...
          <TabPane label="全部页面">
            ...
            <div class="table-status">
              <!-- 左边 -->
              <div class="lf">
                <Checkbox class="status"></Checkbox>
                <Button type="default" class="status">启用</Button>
                <Button type="default" class="status">禁用</Button>
                <Button type="default" class="status">删除</Button>
              </div>
              <!-- 右边 -->
              <div class="rt">
                <Page
          ...
          <TabPane label="商城首页">标签二的内容</TabPane>
          <TabPane label="会员中心页">标签三的内容</TabPane>
          <TabPane label="商品详情页">
            <!-- 表格 -->
            <Table border :columns="columns7" :data="data6"></Table>
            <!-- 表格下边栏 -->
          ...
          <TabPane label="自定义页">标签二的内容</TabPane>
          <TabPane label="启动页">标签三的内容</TabPane>
        </Tabs>
      </div>
    </div>
    <!-- 遮罩层 -->
