...
<template>
    <div id="add-rule-goods">
        <Card>
            <div class="redu-title" style="font-size:22px;margin-bottom:20px;">
                {{role == 1 ? '创建' : role == 2 ? '复制' : '编辑'}}首购礼
            </div>
            <Form ref="formInline" :model="formInline" :rules="ruleInline" :label-width="80">
                <FormItem label="商品名称" prop="title" style="position:relative;">
                    <Input type="text" v-model="formInline.title" @on-change="validTitle" style="width: 350px;" placeholder="请输入商品名称"></Input>
                ...
                <FormItem>
                    <Button type="primary" class="comBtn" @click.native="save('formInline')">保存</Button>
...
export default {
    ...
    methods: {
        ...
        validTitle(e){
            ...
            if(newLength > 20){
                this.$Message.error('商品名称超过20个字符')
            }
