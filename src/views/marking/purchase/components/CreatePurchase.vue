  ...
  <div class="container">
    <div class="redu-box">
      <div class="redu-inset">
        <div class="currentTitle">首购礼/<label> 创建首购礼</label></div>
        <Card>
          <Form :label-width="100" ref="reduForm" :model="reduForm" :rules="reduRule"
            ...
            <div class="inset-content">
              ...
              <FormItem label="活动渠道" prop="smallProgram">
                <Select style="width:300px" v-model="reduForm.smallProgram = '1'">
            ...
            <div class="inset-content">
              ...
              <FormItem label="选择赠品" prop="giftlists">
                <add-gift @listentgoodData="listentgoodDatafuc1($event)" res="+选择赠品" :selectGoods="containerData"></add-gift>
              </FormItem>
            </div>
          </Form>
        </Card>
      ...
      <div class="time-set">
        ...
        <div class="choose-week">
          <Form :label-width="100">
            ...
            <FormItem label="活动时段">
              <span class="star">*</span>
              <TimePicker confirm format="HH:mm:ss" type="timerange" v-model="reduForm.startEnd"
                @on-change='reduForm.startEnd=$event' placement="bottom-end" placeholder="请选择时间段" style="width: 168px">
              </TimePicker>
            </FormItem>
          </Form>
        </div>
