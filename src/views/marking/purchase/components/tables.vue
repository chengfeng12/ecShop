  ...
  <div class="tablePage">
    <div v-if="searchable && searchPlace === 'top'" class="search-con search-con-top">
      <Row>
        ...
        <i-col span="10">
          <Input @on-change="handleClear" clearable placeholder="输入关键字搜索" class="search-input col-8"
            v-model="searchValue" />
        </i-col>
        <i-col span="4">
    ...
    <Table ref="tablesMain" :data="insideTableData" :columns="insideColumns" :stripe="stripe" :border="border"
...
<script>
  // import TablesEdit from "@/components/edit.vue"
  export default {
    name: "Tables",
    props: {
      value: {
