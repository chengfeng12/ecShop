<template>
  <div class="container">
    <div class="currentTitle">选赠礼</div>
    <Card>
      <div class="wrapper">
        <div class="item1">
          <!-- 新增限时折扣 -->
          <router-link :to="{name:'SelectCreateGive'}">
            <Button  v-if="hasRole(40207)" type="primary" size="small" class="comBtn" style="margin-left:0;padding: 3px 8px">+新增选赠礼</Button>
          </router-link>
        </div>
        <div class="item2">
          <!-- 表格  stripe斑马纹-->
