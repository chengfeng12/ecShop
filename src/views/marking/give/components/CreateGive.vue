        ...
        <Card>
          <Form :label-width="100" ref="reduForm" :model="reduForm" :rules="reduRule"
            ...
            <div class="inset-content">
              ...
              <FormItem label="优惠设置" v-model="customized_descs2">
                <div v-for="(item,index) in customized_descs2" :key=" item.index" :value="item.index">
                  <div class="rule-box">
                    <!-- 左边 -->
