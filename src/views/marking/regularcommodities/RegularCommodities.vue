<template>
    <div id="regular-commodities">
      <div class="currentTitle">规则商品</div>
        <Card>
          <div class="rc-con">
            <div class="header">
              <Button size="small" v-if="hasRole(40108)" type="primary" @click="add" class="mar-ri">+添加新商品</Button>
              <Input size="small"  v-model="goodsname" placeholder="输入规则商品名称搜索" style="width: 220px;" class="mar-ri"/>
              <Button size="small"  type="primary" class="mar-ri" @click="searchFun">搜索</Button>
            </div>
            <div class="main">
              <i-table
                border
                        ...
                        return h("div", {
                          ...
                          h('div', {
                            ...
                            style:{
                              ...
                              'padding-right':'10px',
                              'cursor': "pointer",
                              'display': this.hasRole(40108) ?'block':'none',
                            },
                            on: {
                              click: () => {
                          ...
                          h('div', {
                            ...
                            style:{
                              ...
                              'padding':'0 10px',
                              'cursor': "pointer",
                              'display': this.hasRole(4010802) ?'block':'none',
                            },
                            on: {
                              click: () => {
                          ...
                          h('div', {
                            ...
                            style:{
                              'padding':'0 10px',
                              'cursor': "pointer",
                              'display': this.hasRole(4010803) ?'block':'none',
                            },
                            on: {
                              click: () => {
