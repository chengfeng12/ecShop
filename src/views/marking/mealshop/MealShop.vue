<template>
    <div id="regular-commodities">
        ...
        <Card>
            <div class="header">
                <Button type="primary" v-if="hasRole(40111)" @click="add" class="mar-ri">+添加套餐</Button>
...
export default {
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    key: 'price',
                    render:(h,params) => {
                        return h('p',{},params.row.packageType == 1 ? '自组套餐' : '固定套餐')
                    }
                },
                {
                    title: "状态",
                ...
                },
                {
                    ...
                    render: (h,params) => {
                        ...
                        if(!params.row.startingTime){
                            ...
                            let starttime = goodsUtils.timeFun(goodsUtils.timeStamp(params.row.startingTime))
                            let endtime = goodsUtils.timeFun(goodsUtils.timeStamp(params.row.endTime))
                ...
                },
                {
                    ...
                    render: (h,params) => {
                        ...
                        h("Icon", {
                            ...
                            style: {
                                'marginRight': "5px",
                                'display': this.hasRole(4011101) ?'inline':'none',
                            },
                            on: {
                                click: () => {
                        ...
                        h("Icon", {
                            style: {
                                'cursor': "pointer",
                                'marginRight': "5px",
                                'display': this.hasRole(4011102) ?'inline':'none',
                            },
                            class: {
                                iconfont: true,
                                "icon-file-copy": true
                        ...
                        h("Icon", {
                            ...
                            style: {
                                'marginRight': "5px",
                                'display': this.hasRole(4011103) ?'inline':'none',
                            },
                            on: {
                                click: () => {
    ...
    methods: {
        ...
        add() {
            console.log('添加')
            this.$router.push('/@/views/marking/mealshop/components/AddMeal?role=1')
        },
        ...
        editFun(id) {
            this.$router.push('/@/views/marking/mealshop/components/AddMeal?role=3&id=' + id)
        },
        delFun(id) {
            this.delPop = true
        ...
        copyFun(id) {
            console.log('复制')
            this.$router.push('/@/views/marking/mealshop/components/AddMeal?role=2&id=' + id)
        },
        batchDel() {
