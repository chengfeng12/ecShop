<template>
  <div id="page-model">
    <div class="currentTitle">页面模板管理</div>
    <Card>
      <div id="header">
        <Button type="primary"  v-if="hasRole(5010201)" size="small" class="btn-a" @click="add">+添加新模板</Button>
        <Input v-model="name" size="small" placeholder=" 输入页面关键词搜索" style="width: 220px;" class="mar-le"/>
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push(`/@/components/templatePage?type=4`);
    },
