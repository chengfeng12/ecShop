...
<template>
  <div class="shangpinxiangqing diyitem" :options="options">
    <div class="goodsDetail goodsDetail">
      <div class="rel goods-img">
        <img alt src="../../static/img/normal-detail-img1.png">
      </div>
      <div class="goods-msg">
        <div class="goods-info">
          ...
          <div class="flex price-msg">
            ...
            <div class="right-mon">
              预计佣金
              <span class="es-style-text">￥12.4</span>
            </div>
          </div>
          <div class="title">
            商品标题
            <span class="iconfont icon-fenxiang1 pull-right" style="font-weight: normal;"></span>
          </div>
