      ...
      <TabPane label="内容" name="content">
            ...
            >
              <ul class="list-mf" v-for="(item,index) in elementLists" :key="index">
                <li
                  ...
                  :key="cid"
                  :style="{width:child.itemWidth + 'px',height:child.itemHeight + 'px','line-height':child.itemHeight + 'px'}"
        ...
        <!-- <div class="pannelcontent">
          <div class="pannelItem" style="border-bottom:0px">
            ...
            <div class="list-group slide">
              <Slider class="slide-content" v-model="imgPadding" :max="48"></Slider>
  ...
  methods: {
    ...
    confrimCanvas(px, py) {
      ...
      let newObj = {
        id:
          newNum.length == 0
            ? _this.elementLists.length + 1
            : newNum[_this.combineLists.length - 1] + 1,
