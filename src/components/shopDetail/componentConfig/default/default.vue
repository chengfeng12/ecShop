...
<template :options="options">
  <div class="d-config">
        <p class="page-set">页面设置</p>
        <div class="pannelcontent">
          <div class="pannelItem">
            <div class="tit">页面名称</div>
            <div class="inputItem">
              <Input v-model="pageName" @on-change="changePageName"/>
          ...
          <div class="pannelItem">
            ...
            <div class="inputItem">
              <Input v-model="pageTitle" @on-change="changePageTitle"/>
              <div class="inputTips">显示在小程序顶部</div>
            </div>
          </div>
          <div class="pannelItem">
            <div class="tit">页面背景色</div>
...
export default {
  ...
  methods: {
    ...
    changePageName(e) {
      let _this = this;
      _this.pageName = e.srcElement.value;
      _this.changeForm();
    },
    // 页面标题
    changePageTitle(e) {
      let _this = this;
      _this.pageTitle = e.srcElement.value;
      _this.changeForm();
    },
    // 改变标题栏文字颜色
