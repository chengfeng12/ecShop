...
@import "./blankConfig.less";
</style>
<template :options="options">
  <div class="d-config">
    <Tabs value="content" class="d-tab">
      <TabPane label="辅助空白" name="content">
        <div class="pannelcontent">
          ...
          <div class="pannelItem" style="align-items:center;">
            <div class="titspe">空白高度</div>
            <div class="slideDiv">
              <Slider class="slide-content" v-model="udPadding" @on-change="changeContent" :max="200"></Slider>
