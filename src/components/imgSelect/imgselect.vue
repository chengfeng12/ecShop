    ...
    <div v-show="uploadshow" class="imgselect-container">
      <div class="imgselect-content">
        ...
        <div class="imgselect-content-top">
          <div>请选择图片</div>
          <Icon class="iconfont icon-close" @click="closeModel"/>
        </div>
        <div class="imgselect-cont-c clear">
          ...
          <div class="imgselect-cont-r">
            ...
            <ul class="imgselect-cont-r">
              ...
              >
                <img class="imgitem" :src="file.imgAddress" width="100" height="100">
...
import imgApi from "@/api/request/common";
...
export default {
  ...
  methods: {
    ...
    getCategory() {
      let _this = this;
      imgApi.categoryLists({
        type:'image'
      }).then(res => {
        if (res.code == 1) {
          let catelists = res.data;
          _this.category = [];
          catelists.map((v, i) => {
            _this.category.push({
              id: v.id,
